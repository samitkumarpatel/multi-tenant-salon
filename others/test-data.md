...
**curl**
```bash
curl -s -X PUT localhost:8080/api/saloons/<SALOON_ID>/staff/<STAFF_ID>/availability \
  -H 'Content-Type: application/json' \
  -d '[
...
**HTTPie**
```bash
http PUT localhost:8080/api/saloons/<SALOON_ID>/staff/<STAFF_ID>/availability \
...
```bash
curl -s -X POST localhost:8080/api/saloons/<SALOON_ID>/staff \
  -H 'Content-Type: application/json' \
...
```bash
# Classic Haircut
curl -s -X POST localhost:8080/api/saloons/<SALOON_ID>/services \
  -H 'Content-Type: application/json' \
