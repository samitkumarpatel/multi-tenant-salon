 ...
 * create salon → add services/staff → configure availability → book → manage lifecycle.
 */
@SpringBootTest
...
class IntegrationTests {
    ...
    void createSalon() {
        var result = client.post()
                ...
                .jsonPath("$.salonHandler").isEqualTo("integration-salon")
                .jsonPath("$.emailId").isEqualTo("owner@integration.com")
                .jsonPath("$.message").isNotEmpty()
                .returnResult();

        salonId = result.getResponseHeaders().getLocation().getPath().replaceAll(".*/", "");
    }

    @Test
    @Order(2)
    void getMySalonsByEmail() {
        client.get()
                .uri("/api/salon-admin/my-salons?email=owner@integration.com")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$").isArray()
                .jsonPath("$[0].id").isEqualTo(salonId)
                .jsonPath("$[0].owner.email").isEqualTo("owner@integration.com");

        client.get()
                .uri("/api/salon-admin/my-salons?email=nobody@unknown.com")
                .exchange()
    ...
    void getSalonById() {
        client.get()
                .uri("/api/salon/{id}", salonId)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.id").isEqualTo(salonId)
                .jsonPath("$.name").isEqualTo("Integration Salon")
    ...
    void getSalonByHandler() {
        client.get()
                .uri("/api/salon/integration-salon")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$.id").isEqualTo(salonId);
    ...
    void updateSalon() {
        client.put()
                .uri("/api/salon-admin/{id}", salonId)
                .contentType(MediaType.APPLICATION_JSON)
                .body("""
                        {
                            "name": "Integration Salon Pro",
                            "location": {
                                "address": "456 Oak Ave",
                                "city": "Newtown",
                                "state": "NT",
    ...
    @Test
    @Order(6)
    void updateSalonFeatures() {
        client.put()
                .uri("/api/salon-admin/{id}/features", salonId)
                .contentType(MediaType.APPLICATION_JSON)
                .body("""
    ...
    void createAndCancelBooking() {
        ...
        client.post()
                .uri("/api/salon-admin/{salonId}/booking/{bookingId}/cancel", salonId, cancelId)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    void createAndMarkNoShow() {
        ...
        client.post()
                .uri("/api/salon-admin/{salonId}/booking/{bookingId}/no-show", salonId, noShowId)
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    void deleteBooking() {
        ...
        client.delete()
                .uri("/api/salon-admin/{salonId}/booking/{bookingId}", salonId, delId)
                .exchange()
                .expectStatus().isNoContent();
    ...
    void listCountries() {
        client.get()
                .uri("/api/salon-utility/countries")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$").isArray()
    ...
    void listCurrencies() {
        client.get()
                .uri("/api/salon-utility/currencies")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
                .jsonPath("$").isArray()
