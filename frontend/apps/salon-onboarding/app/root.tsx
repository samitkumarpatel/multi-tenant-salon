      ...
      <body>
        {timedOut ? (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100dvh", gap: 16, padding: "0 24px", textAlign: "center", fontFamily: "system-ui, sans-serif", color: "#1c1917" }}>
            ...
            <button onClick={() => window.location.reload()} style={{ padding: "8px 18px", borderRadius: 10, background: "#3d5c1e", color: "#fff", border: "none", cursor: "pointer", fontSize: 13 }}>
              ↻ Retry
            </button>
          </div>
        ) : (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100dvh", gap: 12, color: "#94a3b8", fontFamily: "system-ui, sans-serif" }}>
            <div style={{ width: 24, height: 24, border: "2px solid #e2e8f0", borderTopColor: "#3d5c1e", borderRadius: "50%", animation: "spin 0.75s linear infinite" }} />
