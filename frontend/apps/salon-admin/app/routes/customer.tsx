...
import { ONBOARDING_API as SALON_ONBOARDING_API, apiFetch } from "~/lib/api";
...
export async function clientLoader() {
  try {
    return { salons: await apiFetch<Salon[]>(SALON_ONBOARDING_API), error: null };
  } catch (e: unknown) {
    return { salons: [] as Salon[], error: e instanceof Error ? e.message : "Failed to load salons" };
  }
}
