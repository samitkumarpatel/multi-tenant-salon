...
// Renders a full-document error page (server `detail`, network-down / timeout
// wording, 403/404) whenever a loader or action throws — instead of the
// framework's default white screen.
