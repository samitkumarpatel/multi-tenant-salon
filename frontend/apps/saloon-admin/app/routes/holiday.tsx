...
import type { LayoutContext, SaloonHoliday } from "~/lib/types";
...
function fmtHoliday(h: SaloonHoliday): string {
...
export default function HolidayPage() {
  ...
  useEffect(() => {
    apiFetch<SaloonHoliday[]>(`${ADMIN_API}/${saloonId}/holidays`)
      .then(setHolidays)
  ...
  async function addHoliday() {
    ...
    try {
      ...
      const saved = await apiFetch<SaloonHoliday>(`${ADMIN_API}/${saloonId}/holidays`, {
        method: "POST",
  ...
  async function removeHoliday(id: number) {
    try {
      await apiFetch(`${ADMIN_API}/${saloonId}/holidays/${id}`, { method: "DELETE" });
