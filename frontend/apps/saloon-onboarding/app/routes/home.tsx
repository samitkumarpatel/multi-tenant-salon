...
function CookieBanner() {
  ...
  useEffect(() => {
    if (!localStorage.getItem("my-saloon:cookie-consent")) {
      setVisible(true);
    }
  }, []);

  function save(choice: CookieChoice) {
    localStorage.setItem("my-saloon:cookie-consent", choice);
    setVisible(false);
  }
        ...
        <div className="w-full max-w-2xl">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="text-stone-500 mt-4 text-base leading-relaxed max-w-sm mx-auto">
              One platform for saloon owners and the customers who love them.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              ...
              <div className="flex items-center gap-1.5 mt-8 text-sm font-semibold text-matcha-600 group-hover:gap-2.5 transition-all">
                Explore saloons <ArrowRight className="w-4 h-4" />
              </div>
            </Link>
