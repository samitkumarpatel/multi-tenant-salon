...
# and attaches its custom domain(s). The CNAME / apex / wildcard records that
# point those hostnames at <project>.pages.dev are created in the Cloudflare
# zone by the dns-update stack, fed from this stack's `pages_hostnames` output.
